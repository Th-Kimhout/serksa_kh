      ...
      <div className="grid grid-cols-1 container mx-auto text-center gap-x-5 gap-y-5 md:grid-cols-2 lg:grid-cols-5 md:gap-x-12">
        ...
        <div>
          ...
          <div className="flex mt-5">
            ...
            <p className="text-black dark:text-gray-300">(+855) 95 990 910</p>
          </div>
          <p className="w-full mt-4 text-sm text-textBlack mx-auto dark:text-gray-400">
            © 2024 Copyright GradesBot by <a className="text-blueLight font-bold" href="https://istad.co/">ISTAD</a>. All rights reserveds.&trade;
          </p>
        </div>
      </div>
    </div>
